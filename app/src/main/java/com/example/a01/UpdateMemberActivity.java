...
public class UpdateMemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activty_update_member);
    ...
    private void populateMemberDetails() {
        ...
        if (cursor.moveToFirst()) {
            String name = cursor.getString(cursor.getColumnIndexOrThrow(com.example.a01.DBHelper.KEY_MEMBER_NAME));
            String contact = cursor.getString(cursor.getColumnIndexOrThrow(com.example.a01.DBHelper.KEY_MEMBER_CONTACT));
